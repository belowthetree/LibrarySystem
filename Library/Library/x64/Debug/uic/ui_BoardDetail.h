...
public:
    ...
    void setupUi(QDialog *BoardDetail)
    {
        ...
        label->setGeometry(QRect(420, 30, 131, 41));
        textBrowser = new QTextBrowser(BoardDetail);
        textBrowser->setObjectName(QStringLiteral("textBrowser"));
        textBrowser->setGeometry(QRect(210, 170, 641, 351));
        label_2 = new QLabel(BoardDetail);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(390, 100, 201, 31));
        label_3 = new QLabel(BoardDetail);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(670, 110, 241, 21));
